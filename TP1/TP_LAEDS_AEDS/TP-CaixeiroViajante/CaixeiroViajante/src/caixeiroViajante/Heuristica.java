 ...
 * cada passo, a cidade k (ainda não visitada) entre a ligação (i, j) de cidades
 * já visitadas, cujo custo de inserção seja o mais barato
 *
 * Complexidade: O(n^3)
 *
...
public class Heuristica {
    ...
    /**
     * Calcula a distância total de um determinado caminho fornecido como um
     * vetor de inteiros
     *
     * @param caminho
    ...
    /**
     * Atualiza o conjunto de vértices(cidades) não visitados baseado no
    ...
    /**
     * Faz o passo de inserção da cidade k ainda não presente no caminho entre
     * as cidades i e j já presentes no caminho
     *
     * @param melhorOpcao
     * @param caminho
     */
